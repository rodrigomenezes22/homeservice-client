    ...
    <>
      <section className="bg-light">
        <div className="container">
          <br></br>
          <h1 className="pacifico mt-5 mb-5 font-tertiary">
            Service providers
          </h1>
          <div className="row">
                ...
                service.map((provider) => (
                  <div className="col-11 col-md-11 col-lg-11">
                    <div
                      ...
                      className="card-admin-properties "
                    >
                      <div className="card-header capitalize">
                        {provider?.username?.substring(0, 30)}
                        {provider?.username?.length > 30 ? "..." : ""}
                      </div>
                      <div className="card-with-image">
                        ...
                        <div className="content-card">
                          <p className="m-0 ps-3 opensans font-primary bolder">
                            Service Category: &nbsp;
                          </p>
                      ...
                      <div className="card-desc p-1">
                        <p className="opensans font-gray pe-2 ps-3">
                      ...
                      <div className="buttons-card">
                        ...
                        <button
                          ...
                          onClick={() =>
                            viewProfile(provider?.serviceproviderid)
                          }
                        >
